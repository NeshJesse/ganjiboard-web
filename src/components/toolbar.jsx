...
import { FaMousePointer, FaPen, FaArrowRight, FaFont, FaTrash, FaDownload ,FaUpload, FaPlusCircle, FaHistory} from "react-icons/fa";
...
export default function Toolbar({ currentTool, onToolChange, onClear, onExport, onCreateBoard, onImport, onToggleHistory }) {
  ...
  return (
    <div className="fixed top-4 left-1/2 -translate-x-1/2 bg-white shadow-lg rounded-full flex items-center gap-2 px-4 py-2 z-50">
      <button onClick={onToggleHistory} className="flex items-center px-3 py-2 rounded-full space x-2 hover:bg-gray-200 w-28">
        <FaHistory/><span className="p-2">Boards</span>
